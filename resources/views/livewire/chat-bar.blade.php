<div class="col-md-3 border-end d-flex flex-column p-3 overflow-auto">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h4 class="mb-0">Chats</h4>
        <div class="d-flex">
            <input wire:model.lazy="searchName" type="text" class="form-control form-control-sm" placeholder="Buscar">
            <button role="button" class="btn btn-sm btn-outline-success ms-2" data-bs-target="#newChat" data-bs-toggle="modal"><i class="bi bi-plus-lg"></i></button>
